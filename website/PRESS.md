...
Audacion AI Labs is an independent AI safety research lab founded in 2026 by Dee Williams in Los Angeles, California. We study alignment, behavioral integrity, and governance architecture in post-deployment conditions. Less than 2% of AI safety research studies AI after deployment. We study in the space the other 98% leaves empty.

This page is for journalists, editors, podcast hosts, conference organizers, and anyone covering the AI safety landscape who wants to include Audacion AI Labs in their reporting.
...
[Section reserved for press releases as they are published. Chronological, most recent first.]

---

## MEDIA COVERAGE

[Section reserved for media mentions, interviews, and features as they are published. Each entry includes publication name, headline, date, and link.]

---

## SPEAKING

Dee Williams is available for keynotes, panels, podcast interviews, and conference presentations on the following topics:

Post-deployment AI safety and the 98% research gap.
Citizen science for AI safety.
Substrate governance: the trained disposition layer beneath AI instructions.
Building AI workforces: governance architecture for multi-agent systems.
The intersection of workforce science and AI safety.
From staffing to AI: what 30 years of human workforce systems teach us about AI governance.

For speaking inquiries: speaking@audacionailabs.com

---

## BOTTOM LINKS

Learn more about the lab: About page.
See our research pillars: Our Research.
Follow the lab's work: Follow page.
...
- Boilerplate text should be copy-pasteable (journalists will use it directly)
- Media kit downloads should be prominent and easy to find
- Press releases and media coverage sections should be visually clean with dates, sorted most recent first
- Story ideas section is designed to plant seeds for journalists who want an angle
- Founder headshot and lab logo should be high quality downloads (press needs 300dpi minimum)
- Consider a "subscribe to press updates" email capture for journalists who want to be notified of new releases
- Speaking section should eventually link to a speaker page or one-sheet
